...
//@Composable
//fun AnimalsScreenSplitPreview() {
//    val sample = listOf(
//        Animal(1, "Buddy", "Dog", "2024-08-15", 14.3),
//        Animal(2, "Mittens", "Cat", "2023-05-02",17.7),
//        Animal(3, "Daisy", "Cow", "2022-11-30",18.6)
//    )
//
//    val sample2 = listOf(
//        Customer(1, "Ryan", "rmsack@gamil.com", "(810)-229-1912"),
//        Customer(2, "Elise", "estackett@gmail.com", "(734)-432-2313"),
//        Customer(3, "Adian", "aelwaren@gmail.com", "(734)-940-3213")
//    )
//    var selected by remember { mutableStateOf<Animal?>(null) }
//
//    Row(
